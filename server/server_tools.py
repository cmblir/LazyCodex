...
히스토리: `~/.codex-dashboard-server-tools.json` (최근 20건)
"""
...
HISTORY_PATH = _env_path(
    "CODEX_DASHBOARD_SERVER_TOOLS",
    Path.home() / ".codex-dashboard-server-tools.json",
)
_MAX_HISTORY = 20
...
TOOL_CATALOG: list[dict] = [
    {
        ...
        "supportedModels": ["codex-opus-4-7", "codex-sonnet-4-6"],
    },
    {
        "id": "code_execution",
