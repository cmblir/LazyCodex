...
히스토리: `~/.codex-dashboard-citations-lab.json` (최근 20건)
"""
...
HISTORY_PATH = _env_path(
    "CODEX_DASHBOARD_CITATIONS_LAB",
    Path.home() / ".codex-dashboard-citations-lab.json",
)
_MAX_HISTORY = 20
...
EXAMPLES: list[dict] = [
    {
        ...
        "document": (
            ...
            "공동 창업자에는 전 OpenAI 연구진 다수가 포함됐다. 회사의 플래그십 모델은 Codex 이며, "
