...
사용법:
    ...
    return err("cli_not_installed")  # → {"ok": False, "error": "Codex CLI 미설치", "error_key": "err_cli_not_installed"}
    return err("cli_not_installed", detail="codex")  # → detail 추가
"""
...
ERROR_MESSAGES: dict[str, str] = {
    # ── 공통 ──
    "bad_body":               "잘못된 요청",
    "cli_not_installed":      "Codex CLI 미설치",
    "cli_not_found":          "Codex CLI 를 찾을 수 없습니다",
    "auth_required":          "Codex 계정 연결 필요",
    "timeout":                "응답 시간 초과",
    "cli_error":              "CLI 실행 오류",
    ...
    "no_codex_json":         "~/.codex.json 이 없습니다 — Codex CLI에 로그인하세요.",
    ...
    # ── 번역 ──
    "translate_no_cli":       "Codex CLI 설치 필요",
    "translate_no_auth":      "Codex 계정 연결 필요",
    "translate_no_json":      "번역 JSON 을 찾지 못했습니다",

    # ── AI 평가 ──
    "eval_cli_timeout":       "Codex CLI 시간 초과 — 다시 시도해 주세요",
    "eval_cli_error":         "Codex CLI 실행 실패",
    "eval_no_json":           "Codex 응답에서 JSON 을 찾지 못했습니다",
...
def err(key: str, *, detail: str = "", code: int = 0) -> dict:
    ...
    결과: {"ok": False, "error": "Codex CLI 미설치", "error_key": "err_cli_not_installed"}
    """
