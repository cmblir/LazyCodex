...
from .codex_md import (
    get_codex_md, get_settings, put_codex_md, put_settings,
...
from .features import (
    ...
    api_global_codex_md_recommend, api_optimization_score,
...
from .projects import (
    ...
    api_project_codex_md_get, api_project_codex_md_put,
...
ROUTES_GET: dict[str, Callable[[dict], Any]] = {
    "/api/codex-md": lambda q: get_codex_md(),
    ...
    "/api/project/codex-md": api_project_codex_md_get,
    ...
    # v2.45.0 — Codex CLI Router (CCR / zcodex) wizard
...
ROUTES_POST: dict[str, Callable[[dict], Any]] = {
    ...
    "/api/global/codex-md-recommend": api_global_codex_md_recommend,
    ...
    "/api/memory/kill-idle-codex":       api_kill_idle_codex,
    # v2.45.0 — Codex CLI Router (CCR / zcodex) wizard
