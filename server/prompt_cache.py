...
히스토리: `~/.codex-dashboard-prompt-cache.json` (최근 20건)
"""
...
HISTORY_PATH = _env_path(
    "CODEX_DASHBOARD_PROMPT_CACHE",
    Path.home() / ".codex-dashboard-prompt-cache.json",
)
_MAX_HISTORY = 20
                ...
                "content": [
                    {
                        ...
                        "text": (
                            "다음 문서를 기반으로 답해주세요.\n\n"
                            "<document>\n"
                            + ("Codex API 는 Anthropic 의 고성능 LLM 접근 인터페이스입니다. " * 80)
                            + "\n</document>"
                        ),
                        "cache_control": {"type": "ephemeral"},
                    },
...
_PRICING = {
    "codex-opus-4-7":    {"in": 15.0, "cw": 18.75, "cr": 1.50,  "out": 75.0},
    "codex-sonnet-4-6":  {"in": 3.0,  "cw": 3.75,  "cr": 0.30,  "out": 15.0},
    "codex-haiku-4-5":   {"in": 0.8,  "cw": 1.0,   "cr": 0.08,  "out": 4.0},
}
