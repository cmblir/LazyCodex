...
Direct-API lab: send a prompt to Codex with the memory tool enabled
...
Storage: ``~/.codex-dashboard-memory-lab.json`` (history, ≤50).
"""
...
HISTORY_PATH = _env_path(
    "CODEX_DASHBOARD_MEMORY_LAB",
    Path.home() / ".codex-dashboard-memory-lab.json",
)
_MAX_HISTORY = 50
