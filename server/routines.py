"""Codex CLI Routines — CRUD + run-now over ``~/.codex/scheduled-tasks/*.yaml``.
...
stdlib only):
    ...
    schedule: "0 */6 * * *"
    command: "codex --print 'do the thing'"
    cwd: "~/work/proj"
    enabled: true

Storage: ``~/.codex/scheduled-tasks/<name>.yaml``.
...
ROUTINES_DIR = CODEX_HOME / "scheduled-tasks"
