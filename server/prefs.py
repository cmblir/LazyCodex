...
workflow defaults) in ``~/.codex-dashboard-prefs.json``. The frontend uses
...
PREFS_PATH = _env_path(
    "CODEX_DASHBOARD_PREFS",
    Path.home() / ".codex-dashboard-prefs.json",
)
...
PREFS_SCHEMA: dict[str, dict[str, tuple]] = {
    "ui": {
        ...
        "accentColor":      ("enum", ["codex", "blue", "purple", "green", "orange", "pink"]),
