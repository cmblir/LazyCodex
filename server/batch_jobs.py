...
_BUDGET_PATH = _env_path(
    "CODEX_DASHBOARD_BATCH_BUDGET",
    Path.home() / ".codex-dashboard-batch-budget.json",
...
BATCH_EXAMPLES: list[dict] = [
    ...
    },
    {
        ...
        "maxTokens": 128,
        "prompts": [
            "Codex 는 Anthropic 에서 만든 대규모 언어 모델이다. 그래서 뭘 잘해?",
...
def api_batch_create(body: dict) -> dict:
    ...
    model = (body.get("model") or "codex-haiku-4-5").strip()
