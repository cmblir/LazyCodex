...
_HOME = Path.home()
_DB_PATH = _HOME / ".codex-dashboard.db"
_BACKUPS_DIR = _HOME / ".codex-dashboard-backups"
_SESSIONS_DIR = _HOME / ".codex" / "sessions"
_JSON_GLOB_PATTERN = ".codex-dashboard-*.json"
...
def _disk_usage() -> dict[str, Any]:
    ...
    # Codex CLI sessions — JSONL only, single-level.
