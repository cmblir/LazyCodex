...
_SOURCES = [
    ("promptCache", ".codex-dashboard-prompt-cache.json"),
    ("thinkingLab", ".codex-dashboard-thinking-lab.json"),
    ("toolUseLab", ".codex-dashboard-tool-use-lab.json"),
    ("serverTools", ".codex-dashboard-server-tools.json"),
    ("citationsLab", ".codex-dashboard-citations-lab.json"),
    ("modelBench", ".codex-dashboard-model-bench.json"),
    # vision/files/batch/embedding 은 cost 필드 없는 경우 skip (0 으로 집계)
    ("visionLab", ".codex-dashboard-vision-lab.json"),
    ("apiFiles", ".codex-dashboard-api-files.json"),
]
