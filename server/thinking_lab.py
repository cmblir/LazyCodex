"""Extended Thinking 플레이그라운드 — Codex 의 reasoning block 을 분리 시각화.
...
히스토리: `~/.codex-dashboard-thinking-lab.json` (최근 20건)
"""
...
HISTORY_PATH = _env_path(
    "CODEX_DASHBOARD_THINKING_LAB",
    Path.home() / ".codex-dashboard-thinking-lab.json",
)
_MAX_HISTORY = 20

THINKING_MODELS = [
    {"id": "codex-opus-4-7", "label": "Opus 4.7", "supported": True},
    {"id": "codex-sonnet-4-6", "label": "Sonnet 4.6", "supported": True},
    {"id": "codex-haiku-4-5", "label": "Haiku 4.5", "supported": False},
]
