 ...
 * `codex --version` and `codex auth status` subprocesses (~400ms
 ...
 * auto-invalidates by tracking ~/.codex.json's mtime so a
 * `codex auth login` is reflected without a 30s wait.
 */
