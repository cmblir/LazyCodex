...
test.describe('LazyCodex acceptance', () => {
  ...
  // Terminal command can configure provider settings (`lazycodex get/set`).
  test('terminal lazycodex get/set configures preferences', () => {
