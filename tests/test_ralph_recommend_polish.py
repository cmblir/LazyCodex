...
def project(tmp_path):
    root = tmp_path / "demo"
    root.mkdir()
    (root / "AGENTS.md").write_text("# demo — small project\n", encoding="utf-8")
...
def test_polish_prompt_set_and_get(rec_mod, tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("CODEX_DASHBOARD_RALPH_POLISH", str(cfg_file))
