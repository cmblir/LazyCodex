...
class TestRegistrySingleton:
    ...
    def test_builtin_providers_registered(self):
        ...
        for expected in ("codex-cli", "openai-api", "gemini-api", "ollama-api"):
...
class TestResolveAssignee:
    ...
    def test_empty_assignee_defaults_to_codex(self):
        reg = get_registry()
        pid, _ = reg.resolve_assignee("")
        assert pid == "codex-cli"
...
class TestExtractInlineImages:
    ...
    codex-cli scrubbing path. Make sure the shape stays stable."""
