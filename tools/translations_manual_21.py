"""v2.43.0 — Setup Helpers (global ↔ project scope for AGENTS.md /
...
NEW_EN: dict[str, str] = {
    ...
    # AGENTS.md
    "아직 프로젝트 AGENTS.md 가 없습니다": "No project AGENTS.md yet",
    ...
    "Codex CLI는 프로젝트 ▶ 글로벌 순서로 머지합니다.":
        "Codex CLI merges project then global.",
    ...
    "이 플러그인은 비활성 — Codex CLI 가 호출하지 않습니다.":
        "Plugin is disabled — Codex CLI won't invoke it.",
    "스킬": "Skills",
    "스킬 없음": "No skills",
    "별도": "separate",
    "새 스킬": "New skill",
...
NEW_ZH: dict[str, str] = {
    ...
    "프로젝트":             "项目",
    "인덱스된 프로젝트 없음":  "无已索引项目",
    "AGENTS.md 스코프":     "AGENTS.md 范围",
    "Settings 스코프":      "Settings 范围",
    "스킬 스코프":           "技能范围",
    "명령어 스코프":         "命令范围",
    "훅 스코프":             "钩子范围",

    "아직 프로젝트 AGENTS.md 가 없습니다": "尚无项目 AGENTS.md",
    "이 프로젝트에서 작업할 때만 로드되는 지침을 작성하세요. 저장하면 즉시 ":
