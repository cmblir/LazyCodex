...
NEW_EN: dict[str, str] = {
    ...
    "예: codex:sonnet, openai:gpt-4.1, ollama:llama3.1":
        "e.g. codex:sonnet, openai:gpt-4.1, ollama:llama3.1",
    "Effort": "Effort",
    ...
    "Codex 확장 사고 모드": "Codex extended-thinking mode",
...
NEW_ZH: dict[str, str] = {
    ...
    "기본 프로바이더": "默认提供商",
    "예: codex:sonnet, openai:gpt-4.1, ollama:llama3.1":
        "例：codex:sonnet, openai:gpt-4.1, ollama:llama3.1",
    "Effort": "Effort",
